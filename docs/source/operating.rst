[dateNov07H-f2d7] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [dateNov07H-f2d7] container is NOT running**.

.. tip::
   You must have your [dateNov07H-f2d7] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35413  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Defendx3'  \-\-env DOCKERUSERNAME='defendx'  \-\-env MQTTUSERNAME='defendx3@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   defendx/dateNov07H-f2d7-amd64 (https://hub.docker.com/r/defendx/dateNov07H-f2d7-amd64)
...
.. important::
   docker run -d -p 41961:41961 -p 41665:41665 -p 41627:41627 \-\-env TSS=0 \-\-env SOLUTIONNAME=dateNov07H-f2d7 \-\-env SOLUTIONDAG=solution_preprocessing_dag_mqtt-dateNov07H-f2d7 \-\-env GITUSERNAME=Defendx3  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=41961  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=41665  \-\-env SOLUTIONVIPERVIZPORT=41627 \-\-env DOCKERUSERNAME='defendx'  \-\-env EXTERNALPORT=35413 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='defendx3@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  defendx/dateNov07H-f2d7-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=41627
...
It can be accessed by entering: http://localhost:41665
...
.. important::
   http://localhost:41627/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:41627/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:41627/<html file>
...
[dateNov07H-f2d7] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Defendx3/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/dateNov07H-f2d7
...
.. important::
   https://dateNov07H-f2d7.readthedocs.io
...
.. important::
   solution_preprocessing_dag_mqtt-dateNov07H-f2d7
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.1, VIPERPORT_PRODUCE=41961, VIPERHOST_PREPOCESS=172.17.0.1, VIPERPORT_PREPROCESS=44411, VIPERHOST_PREPOCESS2=172.17.0.1, VIPERPORT_PREPROCESS2=36293, VIPERHOST_PREPOCESS_PGPT=172.17.0.1, VIPERPORT_PREPROCESS_PGPT=45903, VIPERHOST_ML=172.17.0.1, VIPERPORT_ML=43089, VIPERHOST_PREDCT=172.17.0.1, VIPERPORT_PREDICT=41091, HPDEHOST=172.17.0.1, HPDEPORT=35153, HPDEHOST_PREDICT=172.17.0.1, HPDEPORT_PREDICT=34697

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-195-dateNov07H-f2d7,solution_preprocessing_dag_mqtt-dateNov07H-f2d7, python-preprocess-2846-dateNov07H-f2d7,solution_preprocessing_dag_mqtt-dateNov07H-f2d7, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
